...
//        service = CommonUtil.getBean(getServletContext(), EmpService.class);
//        deptService = CommonUtil.getBean(getServletContext(),DeptService.class);
//    }
//    @Override
...
//                EmpDO empDO = service.getOneEmp(empno);
//                if (empDO == null) {
//                    errorMsgs.add("查無資料");
//                }
//                // Send the use back to the form, if there were errors
...
//
////        EmpService empService = new EmpServiceImpl();
//        List<EmpDO> empDOs = service.getAll();
